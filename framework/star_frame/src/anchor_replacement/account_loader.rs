...
use crate::anchor_replacement::ANCHOR_CLOSED_ACCOUNT_DISCRIMINATOR;
...
where
    ...
    T::OwnerProgram: Program<Discriminant = [u8; 8]>,
{
...
impl<'a, 'info, T> AccountSetCleanup<'info, AnchorValidateArgs<'a, 'info>>
    for AccountLoader<'info, T>
where
    T: Pod + ProgramAccount,
    T::OwnerProgram: Program<Discriminant = [u8; 8]>,
